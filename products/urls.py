...
from .api.v1.api_views import (
    APIProductListView,
    APIProductCreateView,
...
urlpatterns = [
    ...
    path(
        "api/<int:pk>/update/", APIProductUpdateView.as_view(), name="APIProductUpdate"
    ),
    path("api/view/<int:pk>/", APIProductDetailView.as_view(), name="APIProductDetail"),
    path(
        "api/<int:pk>/delete/", APIProductDeleteView.as_view(), name="APIProductDelete"
    ),
]
